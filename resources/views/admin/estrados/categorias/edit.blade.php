    ...
    <div class="container justity-center">
        <div class="row">
            <div class="col-md-10">
                ...
                <div class="card-body">
                    {!! Form::model($categoria, ['route' => ['categoriaEstradoUpdate', $categoria->id], 'method' => 'PUT', 'files' => true]) !!}
                        {{  Form::hidden('id', $categoria->id)}}
                        @include('admin.estrados.categorias.partials.form')
                    {!! Form::close() !!}

                </div>


                <h2>Documentos de la categoria</h2>
                    <a href="{{route('docEstradoCreate', ['nivel' => 1, 'id' => $categoria->id])}}" class="btn btn-sm btn-primary btn-right">Nuevo Documento</a>
